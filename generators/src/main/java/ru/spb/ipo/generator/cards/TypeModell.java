...
public class TypeModell extends DefaultComboBoxModel {
	...
	public static final ListElement []  type_cards =  { 
		...
		new ListElement("п€терок", new SimpleGenerator("4", "1")),
		...
		new ListElement("дев€ток", new SimpleGenerator("8", "1")),
		new ListElement("дес€ток", new Generator("9", "1")),
	...
	public static final ListElement [] valueType_cards =  { 
		...
		new ListElement("п€терка", new SimpleGenerator("4", "1")),
		...
		new ListElement("дев€тка", new SimpleGenerator("8", "1")),
		new ListElement("дес€тка", new SimpleGenerator("9", "1")),
	...
	public static final ListElement []  word_cond =  { 
		new ListElement("—лово €вл€етс€ палиндромом", new WordCondition("—лово €вл€етс€ палиндромом")),
		new ListElement("√ласные и согласные чередуютс€", new DiffGenerator("√ласные и согласные чередуютс€")),
		new ListElement("ѕосле каждой согласной идет гласна€", new NextGenerator("ѕосле каждой согласной идет гласна€", 0)),
		new ListElement("ѕосле каждой гласной идет согласна€", new NextGenerator("ѕосле каждой гласной идет согласна€", 1)),
		new ListElement("—огласных меньше чем гласных", new SignGenerator(-1)),
		new ListElement("—огласных больше гласных", new SignGenerator(1)),
		new ListElement("—огласных столько же сколько гласных", new SignGenerator(0))				
	};
