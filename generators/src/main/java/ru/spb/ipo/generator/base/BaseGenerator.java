...
public class BaseGenerator {
    ...
    public String generateDescription() {    	
        return "»з колоды в " + sourceParams.get("colodaDesc") + " карт вытаскивают случайным образом " + sourceParams.get("nabor") + " карт. " +
        (isEmptyInline() ? "ѕодсчитайте количество всех возможных наборов карт." : "ѕодсчитайте количество наборов, в которых " + taskParams.get("inlineDesc") + ".");
    }    
